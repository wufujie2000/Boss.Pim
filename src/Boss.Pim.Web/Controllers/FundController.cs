...
namespace Boss.Pim.Web.Controllers
{
    ...
    {
        public TradeRecordAppService TradeRecordAppService { get; set; }
    ...
    LEFT JOIN dbo.FundCenter_TradeRates rate
        ON rate.FundCode = fun.Code
           ...
           AND rate.Title NOT IN ( '500万 ≤ 购买金额 < 1000万', '100万 ≤ 购买金额 < 500万', '100万 ≤ 购买金额 < 200万',
                                   ...
                                   '300万 ≤ 购买金额 < 500万', '50万 ≤ 购买金额 < 100万', '50万 ≤ 购买金额 < 250万', '250万 ≤ 购买金额 < 500万'
                                 )
...
";
        ...
        [AbpMvcAuthorize]
        public async Task<ActionResult> BuyPost(TradeRecordCreateInput input)
        {
            await TradeRecordAppService.Create(input);
