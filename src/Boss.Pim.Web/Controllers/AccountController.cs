...
using Boss.Pim.Sessions;
using Boss.Pim.Web.Controllers.Results;
using Boss.Pim.Web.Models;
using Boss.Pim.Web.Models.Account;
...
{
    public class AccountController : PimControllerBase
    {
